...
public class GcjUtil {
	...
	public final static Scanner getReaderFor(String inputFileName) {
	...
	public final static FileWriter getWriterFor(String inputFileName) {
		URL url = GcjUtil.class.getResource("/");
		SimpleDateFormat stamp = new SimpleDateFormat("yy-MM-dd_HH-mm-ss");
		try {
			return new FileWriter(new File(
					...
					+ "_"+stamp.format(System.currentTimeMillis()) + "_out.txt", false);
		} catch (IOException e) {
